...
"[project]/src/app/workout/[id]/action.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"4003e8f01c1c32dfff7dbb21e8b6052182e103482d":"deleteWorkoutAction","60c73cebe60f00bb7af7216a77baa69210aed9a9ed":"updateWorkoutAction","60f828201ef522c1c0733a9ff54cd9622f4b354277":"completeWorkoutAction"},"",""] */ __turbopack_context__.s([
...
const UpdateWorkoutSchema = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    title: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'Title is required').max(100, 'Title too long').optional(),
    notes: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(500, 'Notes too long').optional(),
    durationMinutes: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().min(1, 'Duration must be at least 1 minute').max(1440, 'Duration cannot exceed 24 hours').optional(),
    completedAt: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].date().optional().nullable()
});
// Validation schema for workout completion
const CompleteWorkoutSchema = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    durationMinutes: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().min(1, 'Duration must be at least 1 minute').max(1440, 'Duration cannot exceed 24 hours')
});
async function updateWorkoutAction(workoutId, data) {
    try {
        // Validate input data
        ...
        const updatedWorkout = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$workouts$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateWorkout"])(workoutId, userId, validatedData);
        if (!updatedWorkout) {
...
async function deleteWorkoutAction(workoutId) {
    try {
        // Get authenticated user
        const { userId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$app$2d$router$2f$server$2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["auth"])();
        if (!userId) {
        ...
        const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$workouts$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteWorkout"])(workoutId, userId);
        if (!success) {
            throw new Error('Workout not found or access denied');
        }
        return {
...
async function completeWorkoutAction(workoutId, data) {
    try {
        // Validate input data
        ...
        const completedWorkout = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$workouts$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["completeWorkout"])(workoutId, userId, validatedData.durationMinutes);
        if (!completedWorkout) {
            throw new Error('Workout not found or access denied');
        }
        return {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateWorkoutAction, "60c73cebe60f00bb7af7216a77baa69210aed9a9ed", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteWorkoutAction, "4003e8f01c1c32dfff7dbb21e8b6052182e103482d", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(completeWorkoutAction, "60f828201ef522c1c0733a9ff54cd9622f4b354277", null);
}),
];

//# sourceMappingURL=src_d46451f3._.js.map